...
/* harmony import */ var _modules_play_video_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/play-video.js */ "./js/modules/play-video.js");
...
/* harmony import */ var _modules_get_slider_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/get-slider.js */ "./js/modules/get-slider.js");
/* harmony import */ var _modules_get_carousel_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/get-carousel.js */ "./js/modules/get-carousel.js");
/* harmony import */ var _modules_validate_phone_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/validate-phone.js */ "./js/modules/validate-phone.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_scroll__WEBPACK_IMPORTED_MODULE_2__["scrollToElement"])();

  // все скрипты должны быть в обработчике 'DOMContentLoaded', но не все в 'load'
  // в load следует добавить скрипты, не участвующие в работе первого экрана
  window.addEventListener('load', function () {
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_play_video_js__WEBPACK_IMPORTED_MODULE_3__["playVideo"])();
    Object(_modules_toggle_tab_js__WEBPACK_IMPORTED_MODULE_4__["toggleTab"])();
    Object(_modules_get_slider_js__WEBPACK_IMPORTED_MODULE_5__["getSlider"])();
    Object(_modules_get_carousel_js__WEBPACK_IMPORTED_MODULE_6__["getCarousel"])();
    Object(_modules_validate_phone_js__WEBPACK_IMPORTED_MODULE_7__["validatePhone"])();
  });
});
...
var getCarousel = function getCarousel() {
  var feedbacksSwiper = document.querySelector('.feedbacks__swiper');
  var feedbacksSwiperWrapper = document.querySelector('.feedbacks__swiper-wrapper');
  ...
  feedbacksButtons.forEach(function (feedbackButtons) {
    feedbackButtons.classList.remove('feedbacks__button--nojs');
  });
  var swiper = new Swiper('.feedbacks__swiper', {
...
var playVideo = function playVideo() {
  var playButton = document.querySelector('.gym__link');
  var YT = window.YT;
  var player;
...
var scrollToElement = function scrollToElement() {
  var majorButton = document.querySelector('.major__link');
  var scrollElement = document.querySelector('#passes');
...
var toggleTab = function toggleTab() {
  var tabList = document.querySelector('.passes__tabs');
  var contentItems = document.querySelectorAll('.passes__content');
  var monthTab = document.querySelector('.passes__tab-link--month');
  var halfYearTab = document.querySelector('.passes__tab-link--half-year');
  var yearTab = document.querySelector('.passes__tab-link--year');
  var monthContent = document.querySelector('.passes__content--month');
  var halfYearContent = document.querySelector('.passes__content--half-year');
  var yearContent = document.querySelector('.passes__content--year');
  tabList.classList.remove('passes__tabs--nojs');
  contentItems.forEach(function (contentItem) {
    contentItem.classList.remove('passes__content--nojs');
  });
  monthTab.addEventListener('click', function (evt) {
    evt.preventDefault();
  ...
  halfYearTab.addEventListener('click', function (evt) {
    evt.preventDefault();
  ...
  yearTab.addEventListener('click', function (evt) {
    evt.preventDefault();
    monthTab.classList.remove('is-active');
    monthContent.classList.remove('is-active');
    halfYearTab.classList.remove('is-active');
